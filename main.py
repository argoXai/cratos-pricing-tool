...
with tab3:
    ...
    selected_parent = st.selectbox("Select a Parent Sector", parent_sectors, index=None)
    selected_child = st.selectbox("Select a Child Sector", sector_dict[selected_parent], index=None)

...
industry_mapping = {'Misc. Fabricated Products': ['Basic Materials', None, None, None, 0.0],
 'Fabricated Plastic & Rubber': ['Basic Materials', None, None, None, 0.0],
 'Containers & Packaging': ['Basic Materials', None, None, None, 0.0],
 'Metal Mining': ['Basic Materials', None, None, None, 0.0],
 'Gold & Silver': ['Basic Materials', None, None, None, 0.0],
 'Chemical Manufacturing': ['Basic Materials', None, None, None, 0.0],
 'Iron & Steel': ['Basic Materials', None, None, None, 0.0],
 'Non-Metallic Mining': ['Basic Materials', None, None, None, 0.0],
 'Chemicals - Plastics & Rubber': ['Basic Materials', None, None, None, 0.0],
 'Paper & Paper Products': ['Basic Materials', None, None, None, 0.0],
 'Forestry & Wood Products': ['Basic Materials', None, None, None, 0.0],
 'Mobile Homes & RVs': ['Capital Goods', None, None, None, 0.0],
 'Aerospace & Defense': ['Capital Goods', None, None, None, 0.0],
 'Misc. Capital Goods': ['Capital Goods', None, None, None, 0.0],
 'Constr. & Agric. Machinery': ['Capital Goods', None, None, None, 0.0],
 'Construction Services': ['Capital Goods', None, None, None, 0.0],
 'Construction - Raw Materials': ['Capital Goods', None, None, None, 0.0],
 'Constr. - Supplies & Fixtures': ['Capital Goods', None, None, None, 0.0],
 'Conglomerates': ['Conglomerates', None, None, None, 0.0],
 'Appliance & Tool': ['Consumer Cyclical', None, None, None, 0.0],
 'Auto & Truck Manufacturers': ['Consumer Cyclical', None, None, None, 0.0],
 'Recreational Products': ['Consumer Cyclical', None, None, None, 0.0],
 'Auto & Truck Parts': ['Consumer Cyclical', None, None, None, 0.0],
 'Apparel/Accessories': ['Consumer Cyclical', None, None, None, 0.0],
 'Jewelry & Silverware': ['Consumer Cyclical', None, None, None, 0.0],
 'Footwear': ['Consumer Cyclical', None, None, None, 0.0],
 'Furniture & Fixtures': ['Consumer Cyclical', None, None, None, 0.0],
 'Textiles - Non Apparel': ['Consumer Cyclical', None, None, None, 0.0],
 'Audio & Video Equipment': ['Consumer Cyclical', None, None, None, 0.0],
 'Tires': ['Consumer Cyclical', None, None, None, 0.001457725948],
 'Photography': ['Consumer Cyclical', None, None, None, 0.0],
 'Beverages (Alcoholic)': ['Consumer Non-Cyclical', None, None, None, 0.0],
 'Food Processing': ['Consumer Non-Cyclical', None, None, None, 0.0],
 'Office Supplies': ['Consumer Non-Cyclical', None, None, None, 0.0],
 'Personal & Household Products': ['Consumer Non-Cyclical',
  None,
  None,
  None,
  0.0],
 'Crops': ['Consumer Non-Cyclical', None, None, None, 0.0],
 'Beverages (Non-Alcoholic)': ['Consumer Non-Cyclical', None, None, None, 0.0],
 'Fish/Livestock': ['Consumer Non-Cyclical', None, None, None, 0.002915451895],
 'Tobacco': ['Consumer Non-Cyclical', 0.0, None, None, 0.0],
 'Oil & Gas Operations': ['Energy', None, None, None, 0.1574344023],
 'Oil Well Services & Equipment': ['Energy', None, None, None, 0.0],
 'Oil & Gas - Integrated': ['Energy', None, None, None, 0.0],
 'Coal': ['Energy', None, None, None, 0.0],
 'Alternative Energy': ['Energy', None, None, None, 0.0],
 'Insurance (Accident & Health)': ['Financial', None, None, None, 0.0],
 'Insurance (Prop. & Casualty)': ['Financial', None, None, None, 0.0],
 'Other (Mutual Fund)': ['Financial', None, None, None, 0.0],
 'Investment Services': ['Financial', None, None, None, 0.3731778426],
 'S&Ls/Savings Banks': ['Financial', None, None, None, 0.0],
 'Insurance (Miscellaneous)': ['Financial', None, None, None, 0.0],
 'Misc. Financial Services': ['Financial', None, None, None, 0.250728863],
 'Money Center Banks': ['Financial', None, None, None, 0.1690962099],
 'Consumer Financial Services': ['Financial',
  1.0,
  'Data Privacy',
  'E&O ',
  0.1909620991],
 'Insurance (Life)': ['Financial', None, None, None, 0.0],
 'Regional Banks': ['Financial', None, None, None, 0.2346938776],
 'Healthcare Facilities': ['Healthcare', None, None, None, 0.1851311953],
 'Medical Equipment & Supplies': ['Healthcare', None, None, None, 0.3950437318],
 'Biotechnology & Drugs': ['Healthcare', None, None, None, 1.0],
 'Major Drugs': ['Healthcare', None, None, None, 0.0],
 'Business Services': ['Services', None, None, None, 0.3206997085],
 'Waste Management Services': ['Services', None, None, None, 0.0],
 'Communications Services': ['Services', None, None, None, 0.2827988338],
 'Real Estate Operations': ['Services',
  1.0,
  'Property & Planning Matters',
  'Condition of the Property',
  0.0],
 'Broadcasting & Cable TV': ['Services', None, None, None, 0.0],
 'Restaurants': ['Services', None, None, None, 0.0],
 'Printing & Publishing': ['Services', None, None, None, 0.001457725948],
 'Retail (Drugs)': ['Services', None, None, None, 0.0],
 'Casinos & Gaming': ['Services', None, None, None, 0.0],
 'Retail (Specialty)': ['Services', None, None, None, 0.0],
 'Retail & Repair (Automotive)': ['Services', None, None, None, 0.0],
 'Personal Services': ['Services', None, None, None, 0.0],
 'Recreational Activities': ['Services', None, None, None, 0.0],
 'Motion Pictures': ['Services', None, None, None, 0.0],
 'Rental & Leasing': ['Services', None, None, None, 0.0],
 'Retail (Apparel)': ['Services', None, None, None, 0.0],
 'Schools': ['Services', None, None, None, 0.0],
 'Retail (Home Improvement)': ['Services', None, None, None, 0.0],
 'Retail (Department & Discount)': ['Services', None, None, None, 0.0],
 'Retail (Catalog & Mail Order)': ['Services', None, None, None, 0.0],
 'Hotels & Motels': ['Services', None, None, None, 0.0],
 'Security Systems & Services': ['Services', None, None, None, 0.0],
 'Advertising': ['Services', None, None, None, 0.0],
 'Printing Services': ['Services', None, None, None, 0.0],
 'Retail (Grocery)': ['Services', None, None, None, 0.0],
 'Retail (Technology)': ['Services', None, None, None, 0.0],
 'Semiconductors': ['Technology', None, None, None, 0.2740524781],
 'Computer Hardware': ['Technology', None, None, None, 0.0],
 'Communications Equipment': ['Technology', None, None, None, 0.3542274052],
 'Software & Programming': ['Technology', None, None, None, 0.9052478134],
 'Computer Networks': ['Technology', None, None, None, 0.0],
 'Computer Services': ['Technology', None, None, None, 0.3177842566],
 'Computer Peripherals': ['Technology', None, None, None, 0.0],
 'Electronic Instruments & Controls': ['Technology',
  None,
  None,
  None,
  0.1370262391],
 'Office Equipment': ['Technology', None, None, None, 0.0],
 'Computer Storage Devices': ['Technology', None, None, None, 0.0],
 'Scientific & Technical Instr.': ['Technology', None, None, None, 0.0],
 'Airline': ['Transportation', None, None, None, 0.0],
 'Railroads': ['Transportation', None, None, None, 0.0],
 'Misc. Transportation': ['Transportation', None, None, None, 0.0],
 'Trucking': ['Transportation', None, None, None, 0.0],
 'Air Courier': ['Transportation', None, None, None, 0.001457725948],
 'Water Transportation': ['Transportation', None, None, None, 0.0],
 'Natural Gas Utilities': ['Utilities', None, None, None, 0.0],
 'Electric Utilities': ['Utilities', None, None, None, 0.1253644315],
 'Water Utilities': ['Utilities', None, None, None, 0.0]}

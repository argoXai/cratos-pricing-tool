...
industry_mapping = {
    'Misc. Fabricated Products': ['Basic Materials', np.nan, np.nan, np.nan, np.nan],
    'Fabricated Plastic & Rubber': ['Basic Materials', np.nan, np.nan, np.nan, np.nan],
    'Containers & Packaging': ['Basic Materials', np.nan, np.nan, np.nan, np.nan],
    'Metal Mining': ['Basic Materials', np.nan, np.nan, np.nan, np.nan],
    'Gold & Silver': ['Basic Materials', np.nan, np.nan, np.nan, np.nan],
    'Chemical Manufacturing': ['Basic Materials', np.nan, np.nan, np.nan, np.nan],
    'Iron & Steel': ['Basic Materials', np.nan, np.nan, np.nan, np.nan],
    'Non-Metallic Mining': ['Basic Materials', np.nan, np.nan, np.nan, np.nan],
    'Chemicals - Plastics & Rubber': ['Basic Materials', np.nan, np.nan, np.nan, np.nan],
    'Paper & Paper Products': ['Basic Materials', np.nan, np.nan, np.nan, np.nan],
    'Forestry & Wood Products': ['Basic Materials', np.nan, np.nan, np.nan, np.nan],
    'Mobile Homes & RVs': ['Capital Goods', np.nan, np.nan, np.nan, np.nan],
    'Aerospace & Defense': ['Capital Goods', np.nan, np.nan, np.nan, np.nan],
    'Misc. Capital Goods': ['Capital Goods', np.nan, np.nan, np.nan, np.nan],
    'Constr. & Agric. Machinery': ['Capital Goods', np.nan, np.nan, np.nan, np.nan],
    'Construction Services': ['Capital Goods', np.nan, np.nan, np.nan, np.nan],
    'Construction - Raw Materials': ['Capital Goods', np.nan, np.nan, np.nan, np.nan],
    'Constr. - Supplies & Fixtures': ['Capital Goods', np.nan, np.nan, np.nan, np.nan],
    'Conglomerates': ['Conglomerates', np.nan, np.nan, np.nan, np.nan],
    'Appliance & Tool': ['Consumer Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Auto & Truck Manufacturers': ['Consumer Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Recreational Products': ['Consumer Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Auto & Truck Parts': ['Consumer Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Apparel/Accessories': ['Consumer Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Jewelry & Silverware': ['Consumer Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Footwear': ['Consumer Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Furniture & Fixtures': ['Consumer Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Textiles - Non Apparel': ['Consumer Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Audio & Video Equipment': ['Consumer Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Tires': ['Consumer Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Photography': ['Consumer Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Beverages (Alcoholic)': ['Consumer Non-Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Food Processing': ['Consumer Non-Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Office Supplies': ['Consumer Non-Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Personal & Household Products': ['Consumer Non-Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Crops': ['Consumer Non-Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Beverages (Non-Alcoholic)': ['Consumer Non-Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Fish/Livestock': ['Consumer Non-Cyclical', np.nan, np.nan, np.nan, np.nan],
    'Tobacco': ['Consumer Non-Cyclical', 0.0, np.nan, np.nan, np.nan],
    'Oil & Gas Operations': ['Energy', np.nan, np.nan, np.nan, np.nan],
    'Oil Well Services & Equipment': ['Energy', np.nan, np.nan, np.nan, np.nan],
    'Oil & Gas - Integrated': ['Energy', np.nan, np.nan, np.nan, np.nan],
    'Coal': ['Energy', np.nan, np.nan, np.nan, np.nan],
    'Alternative Energy': ['Energy', np.nan, np.nan, np.nan, np.nan],
    'Insurance (Accident & Health)': ['Financial', np.nan, np.nan, np.nan, np.nan],
    'Insurance (Prop. & Casualty)': ['Financial', np.nan, np.nan, np.nan, np.nan],
    'Other (Mutual Fund)': ['Financial', np.nan, np.nan, np.nan, np.nan],
    'Investment Services': ['Financial', np.nan, np.nan, np.nan, np.nan],
    'S&Ls/Savings Banks': ['Financial', np.nan, np.nan, np.nan, np.nan],
    'Insurance (Miscellaneous)': ['Financial', np.nan, np.nan, np.nan, np.nan],
    'Misc. Financial Services': ['Financial', np.nan, np.nan, np.nan, np.nan],
    'Money Center Banks': ['Financial', np.nan, np.nan, np.nan, np.nan],
    'Consumer Financial Services': ['Financial', 1.0, 'Data Privacy', 'E&O ', 0.75],
    'Insurance (Life)': ['Financial', np.nan, np.nan, np.nan, np.nan],
    'Regional Banks': ['Financial', np.nan, np.nan, np.nan, np.nan],
    'Healthcare Facilities': ['Healthcare', np.nan, np.nan, np.nan, np.nan],
    'Medical Equipment & Supplies': ['Healthcare', np.nan, np.nan, np.nan, np.nan],
    'Biotechnology & Drugs': ['Healthcare', np.nan, np.nan, np.nan, np.nan],
    'Major Drugs': ['Healthcare', np.nan, np.nan, np.nan, np.nan],
    'Business Services': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Waste Management Services': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Communications Services': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Real Estate Operations': ['Services', 1.0, 'Property & Planning Matters', 'Condition of the Property', 0.0],
    'Broadcasting & Cable TV': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Restaurants': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Printing & Publishing': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Retail (Drugs)': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Casinos & Gaming': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Retail (Specialty)': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Retail & Repair (Automotive)': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Personal Services': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Recreational Activities': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Motion Pictures': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Rental & Leasing': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Retail (Apparel)': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Schools': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Retail (Home Improvement)': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Retail (Department & Discount)': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Retail (Catalog & Mail Order)': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Hotels & Motels': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Security Systems & Services': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Advertising': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Printing Services': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Retail (Grocery)': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Retail (Technology)': ['Services', np.nan, np.nan, np.nan, np.nan],
    'Semiconductors': ['Technology', np.nan, np.nan, np.nan, np.nan],
    'Computer Hardware': ['Technology', np.nan, np.nan, np.nan, np.nan],
    'Communications Equipment': ['Technology', np.nan, np.nan, np.nan, np.nan],
    'Software & Programming': ['Technology', np.nan, np.nan, np.nan, np.nan],
    'Computer Networks': ['Technology', np.nan, np.nan, np.nan, np.nan],
    'Computer Services': ['Technology', np.nan, np.nan, np.nan, np.nan],
    'Computer Peripherals': ['Technology', np.nan, np.nan, np.nan, np.nan],
    'Electronic Instruments & Controls': ['Technology', np.nan, np.nan, np.nan, np.nan],
    'Office Equipment': ['Technology', np.nan, np.nan, np.nan, np.nan],
    'Computer Storage Devices': ['Technology', np.nan, np.nan, np.nan, np.nan],
    'Scientific & Technical Instr.': ['Technology', np.nan, np.nan, np.nan, np.nan],
    'Airline': ['Transportation', np.nan, np.nan, np.nan, np.nan],
    'Railroads': ['Transportation', np.nan, np.nan, np.nan, np.nan],
    'Misc. Transportation': ['Transportation', np.nan, np.nan, np.nan, np.nan],
    'Trucking': ['Transportation', np.nan, np.nan, np.nan, np.nan],
    'Air Courier': ['Transportation', np.nan, np.nan, np.nan, np.nan],
    'Water Transportation': ['Transportation', np.nan, np.nan, np.nan, np.nan],
    'Natural Gas Utilities': ['Utilities', np.nan, np.nan, np.nan, np.nan],
    'Electric Utilities': ['Utilities', np.nan, np.nan, np.nan, np.nan],
    'Water Utilities': ['Utilities', np.nan, np.nan, np.nan, np.nan]
}
